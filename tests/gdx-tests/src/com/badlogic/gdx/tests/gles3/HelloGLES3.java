...
public class HelloGLES3 extends GdxTest {
	...
	public void create() {
		...
		String vertexShader = "#version " + ShaderProgram.getGLSLVersion() + "\n" +
				"in vec4 vPosition;           \n" +
				"void main()                  \n" +
				"{                            \n" +
				"   gl_Position = vPosition;  \n" +
				"}                            \n";
		String fragmentShader = "#version " + ShaderProgram.getGLSLVersion() + "\n" +
				"#ifdef GL_ES                               \n" +
